...
Its May 1995. You've just landed a dream job at the hot new startup of the decade: [Netscape](https://en.wikipedia.org/wiki/Netscape_Navigator). You've just arrived and you want to impress. The gurus in charge ask you to add a programming language to the Web. 
