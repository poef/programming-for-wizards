...
And even though there now is a clear standard module system, what we end up using is an incompatible version of it, based on [npm](https://www.npmjs.com/) packages. This was originally designed for [Node](https://nodejs.org/), a JavaScript engine for the Server, not the Browser.
